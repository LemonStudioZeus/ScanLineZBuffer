// ScanLineZBuffer.cpp : Defines the class behaviors for the application.
//
...
// CScanLineZBufferApp construction
...
// The one and only CScanLineZBufferApp object

CScanLineZBufferApp theApp;


// CScanLineZBufferApp initialization
...
BOOL CScanLineZBufferApp::InitInstance()
{
	...
	SetRegistryKey(_T("ScanLineZbuffer"));
...
protected:
	DECLARE_MESSAGE_MAP()
public:
	afx_msg void OnUpdateToolYzchange(CCmdUI *pCmdUI);
};
...
// CScanLineZBufferApp message handlers
